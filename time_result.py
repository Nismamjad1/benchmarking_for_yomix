...
#     bar = ax.bar(
#         x + i * width - (len(methods) - 1) * width / 2,
#         pivot[method],
#         width,
#         label=method,
#     )
...
runtime = pd.read_csv("result/test_pbmc_runtime.csv", index_col=0)
