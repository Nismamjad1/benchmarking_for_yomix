...
def save_results(
    ...
    method,
    selected_dataset,
    output_dir="/home/nisma/new_yomix/yomix/output",
):
    """
    ...
    if marker_method == "cosg":
        output_csv = os.path.join(
            output_dir, f"benchmark_mcc_scores_{selected_dataset}_{marker_method}.csv"
        )
    else:  # If using scanpy methods
        output_csv = os.path.join(
            output_dir,
            f"benchmark_mcc_scores_{selected_dataset}_{marker_method}_{method}_{comaprsion_mode}.csv",
        )
