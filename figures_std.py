...
scanpy_wilcoxon = pd.read_csv(
    "output/benchmark/benchmarking_for_yomix/output/TCGA/benchmark_mcc_scores_TCGA_scanpy_wilcoxon_one-vs-rest.csv"
)
cosg = pd.read_csv(
    "output/benchmark/benchmarking_for_yomix/output/TCGA/benchmark_mcc_scores_TCGA_cosg.csv"
)
yomix = pd.read_csv(
    "output/benchmark/benchmarking_for_yomix/output/TCGA/yomix - Sheet1.csv"
)
scanpy_ttest = pd.read_csv(
    "output/benchmark/benchmarking_for_yomix/output/TCGA/benchmark_mcc_scores_TCGA_scanpy_t-test_one-vs-rest.csv"
)
# Add method labels
yomix["Method"] = "Yomix"
